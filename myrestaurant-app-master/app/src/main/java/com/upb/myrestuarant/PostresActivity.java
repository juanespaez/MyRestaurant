...
public class PostresActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.imagenProducto = R.drawable.helados;
        ...
        productoActual2.imagenProducto = R.drawable.waffles;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ing_postre3);
        productoActual3.precioProducto = this.getResources().getString(R.string.prec_postre3); // ;)
        productoActual3.imagenProducto = R.drawable.torta;
